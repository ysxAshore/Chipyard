...
int main()
{
    ...
    int oh,ow,oc;
    printf("input n,ih,iw,ic:");
    scanf("%d %d %d %d",&n,&ih,&iw,&ic);
    printf("input kernel_size,conv_stride:");
    scanf("%d %d",&kernel_size,&conv_stride);
    printf("input oh,ow,oc:");
    scanf("%d %d %d",&oh,&ow,&oc);
