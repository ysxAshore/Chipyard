...
def get_all_test_cycle():
    ...
    with open("resnet50_conv_task.txt", "r") as f:
        ...
        for line in lines:
            ...
            num = num[0]
            print("conv_"+num)
            logpath = "/root/chipyard/sims/verilator/output/chipyard.TestHarness.CUTETestConfig-128bitddr-512bit-l2/vec_ops_conv_2.log"
            #整行替换
            logpath = logpath.replace("vec_ops_conv_2.log", "vec_ops_conv_"+num+".log")
