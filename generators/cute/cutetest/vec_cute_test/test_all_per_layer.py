...
def run_command(x, progress, total, lock):
    ...
    /root/chipyard/scripts/smartelf2hex.sh /root/chipyard/generators/boom/src/main/resources/cutetest/cute_test_with_vec/vec_cute_test/vec_ops_conv_{x}.riscv > /root/chipyard/sims/verilator/output/chipyard.TestHarness.CUTETestConfig/vec_ops_conv_{x}.loadmem_hex
    ...
    +loadmem=/root/chipyard/sims/verilator/output/chipyard.TestHarness.CUTETestConfig/vec_ops_conv_{x}.loadmem_hex \\
    ...
    </dev/null 2> >(spike-dasm > /root/chipyard/sims/verilator/output/chipyard.TestHarness.CUTETestConfig/vec_ops_conv_{x}.out) \\
    | tee /root/chipyard/sims/verilator/output/chipyard.TestHarness.CUTETestConfig/vec_ops_conv_{x}.log)
    """
