...
# /root/chipyard/generators/boom/src/main/resources/cutetest/cute_test_with_vec/vec_test_t/vec_ops_kernel_shift_scale.riscv
    ...
    /root/chipyard/scripts/smartelf2hex.sh /root/chipyard/generators/boom/src/main/resources/cutetest/cute_test_with_vec/vec_test_t/{x}.riscv > /root/chipyard/sims/verilator/output/chipyard.TestHarness.CUTETestConfig/{x}.loadmem_hex
    ...
    +loadmem=/root/chipyard/sims/verilator/output/chipyard.TestHarness.CUTETestConfig/{x}.loadmem_hex \\
    ...
    </dev/null 2> >(spike-dasm > /root/chipyard/sims/verilator/output/chipyard.TestHarness.CUTETestConfig/{x}.out) \\
    | tee /root/chipyard/sims/verilator/output/chipyard.TestHarness.CUTETestConfig/{x}.log)
    """
