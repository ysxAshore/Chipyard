...
class YJPAbstractConfig extends Config(
  // ================================================
  //   Set up TestHarness
  // ================================================
  // The HarnessBinders control generation of hardware in the TestHarness
//   new chipyard.harness.WithUARTAdapter ++                          /** add UART adapter to display UART on stdout, if uart is present */ //提供一个simuart，目标是链接到verilator提供的假的uart上，与主机进行通信
...
//   new chipyard.iobinders.WithUARTIOCells ++ //生成chipyard内部的uartcells，通过tl连接到chipyard内部的tl总线的拓扑上，同时生成好ports，ports用于chiptop生成对外的所有接口信息线
